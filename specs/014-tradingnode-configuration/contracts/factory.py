"""
TradingNode Configuration Factory
...
from .config_models import TradingNodeSettings


class TradingNodeConfigFactory:
    """Factory for creating TradingNodeConfig instances."""
    ...
    def from_settings(
        ...
        """
        Create TradingNodeConfig from validated settings.
    ...
    def _build_logging_config(cls, settings: TradingNodeSettings) -> LoggingConfig:
        ...
        return LoggingConfig(
            ...
            log_file_format=settings.logging.log_format
    ...
    def _build_data_clients(cls, settings: TradingNodeSettings) -> dict:
        ...
        if settings.binance:
            ...
            clients["BINANCE"] = BinanceLiveDataClientConfig(
    ...
    def _build_exec_clients(cls, settings: TradingNodeSettings) -> dict:
        ...
        if settings.binance:
            account_type = cls._BINANCE_ACCOUNT_TYPES[settings.binance.account_type]
            clients["BINANCE"] = BinanceLiveExecClientConfig(
                account_type=account_type,
                testnet=settings.binance.testnet,
                us=settings.binance.us,
