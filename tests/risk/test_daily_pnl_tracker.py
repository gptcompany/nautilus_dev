...
def mock_strategy():
    ...
    # Mock clock
    strategy.clock.utc_now.return_value = datetime(2024, 1, 15, 12, 0, 0, tzinfo=timezone.utc)
...
class TestReset:
    ...
    def test_reset_updates_day_start(self, tracker, mock_strategy):
        ...
        mock_strategy.clock.utc_now.return_value = datetime(
            2024, 1, 16, 0, 0, 0, tzinfo=timezone.utc
        )
...
class TestEdgeCases:
    ...
    def test_timezone_aware_datetime(self, tracker):
        ...
        assert tracker.day_start.tzinfo == timezone.utc
