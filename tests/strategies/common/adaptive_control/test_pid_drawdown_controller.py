...
class TestEdgeCases:
    ...
    def test_rapid_drawdown_increase(self, default_pid):
        """Rapid drawdown increase should trigger strong response."""
        # Start low
    ...
    def test_rapid_drawdown_decrease(self, default_pid):
        ...
        # Start high
        default_pid.update(current_drawdown=0.10)
        state_high = default_pid.get_state()
...
class TestPIDvsSimple:
    ...
    def test_pid_has_memory_simple_does_not(self, default_pid, simple_scaler):
        ...
        for _ in range(10):
            pid_mult1 = default_pid.update(current_drawdown=0.05)
...
class TestProductionScenarios:
    ...
    def test_drawdown_event(self, default_pid):
        ...
        # After multiple steps with high drawdown, should reduce significantly
        # But won't reach < 0.5 immediately due to sigmoid mapping
    ...
    def test_sustained_high_drawdown_reduces_significantly(self, default_pid):
        """Sustained high drawdown should eventually reduce multiplier significantly."""
