...
class MockMetaController:
    ...
    def update(self, current_price=None, current_drawdown=None, current_regime=None,
               current_return=None, current_equity=None, **kwargs):
...
class TestAlphaEvolveBridgeFindUnderperformers:
    ...
    def test_finds_bottom_performers(self):
        ...
        state = MockMetaState(
            strategy_weights={"s1": 0.1, "s2": 0.2, "s3": 0.3, "s4": 0.4}
        )
