...
class TestRecursiveVariance:
    ...
    def test_variance_calculation(self):
        ...
        assert 80 < rv.variance < 120  # True var = 100
    ...
    def test_mean_property(self):
        ...
        # Mean should be roughly 30 with decay
        assert 20 < rv.mean < 40
...
class TestIIRRegimeDetector:
    ...
    def test_trending_detection(self, volatile_returns):
        ...
        # High volatility should trigger trending
        assert regime in ["trending", "normal"]
